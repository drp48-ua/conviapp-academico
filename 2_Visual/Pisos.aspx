<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Pisos.aspx.cs" Inherits="Pisos" %>
    ...
    <head>
        ...
        <title>ConviApp – Pisos</title>
        <link rel="stylesheet" href="css/estilos.css" />
    </head>

    <body>
        <!-- ============================================================
     Pisos.aspx – Capa Visual (Web Forms)
     ...
     ============================================================ -->
        ...
        <main style="max-width:1100px;margin:40px auto;padding:0 24px;">
            ...
            <div style="display:flex;justify-content:space-between;align-items:center;margin-bottom:24px;">
                <h1>🏢 Mis Pisos</h1>
                <asp:Button ID="btnNuevoPiso" runat="server" Text="+ Añadir Piso" CssClass="btn btn-primary"
            ...
            <asp:GridView ID="gvPisos" runat="server" AutoGenerateColumns="false" CssClass="table"
                EmptyDataText="No tienes pisos registrados. ¡Añade el primero!" OnRowCommand="GvPisos_RowCommand">
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Habitaciones">
                        <ItemTemplate>
                            <span>
                                <%# Eval("NumeroHabitaciones") %> hab. / <%# Eval("NumeroBanos") %> baño(s)
                            </span>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Precio">
                        <ItemTemplate>
                            <strong>
                                <%# string.Format("{0:0.00} €", Eval("PrecioTotal")) %>
                            </strong><br />
                    ...
                    <asp:TemplateField HeaderText="Acciones">
                        <ItemTemplate>
                            <asp:LinkButton ID="lnkEditar" runat="server" CommandName="Editar"
                                CommandArgument='<%# Eval("Id") %>' CssClass="btn btn-outline btn-sm">✏️ Editar
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <asp:Panel ID="pnlFormPiso" runat="server" Visible="false" CssClass="flat-card" style="margin-top:32px;">
                <h2 style="margin-bottom:20px;">Añadir nuevo piso</h2>
